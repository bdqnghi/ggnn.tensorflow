...
TRANSFORMATION=BooleanExchange
DATASET=java-small
DATASET_TRANSFORMED=${TRANSFORMATION}/java-small-graph-transformed
...
PYTHON=python3
TASK=0
${PYTHON} produce_misprediction_files.py --val_path ${VAL_PATH} --batch_size ${BATCH_SIZE} \
--dataset ${DATASET} \
